...
- **Test tier coverage** (`tests/core/test-tier-coverage.test.ts` enforces core ⊇ smoke): governs "which test files belong to which tier" and is orthogonal to source-line coverage.
